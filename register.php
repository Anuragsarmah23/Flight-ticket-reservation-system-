...
<?php
	if(isset($_POST['register']))
	{
		...
		$query2=mysqli_query($con,"select * from user WHERE phone='$phone'");
		$count2=mysqli_num_rows($query2);
		
		if($count1==1)
		{
			echo "<script>alert('Email ID Already Exists'); location.href='register.php';</script>";
		}
		if($count2==1)
		{
			echo "<script>alert('Mobile Number Already Exists'); location.href='register.php';</script>";
		}
		if($count1==0 && $count2==0)
		{
			$query3=mysqli_query($con,"INSERT INTO user (name,phone,email,password) VALUES('$name','$phone','$email','$password')");
			echo "<script>alert('You Have Successfully Registered. Now Logging in To Book Your Filght'); location.href='login.php';</script>";	
		}	
	}
?>
	<!DOCTYPE html>
							...
							<div class="tab-content" id="myTabContent">
							  <div class="tab-pane fade show active" id="flight" role="tabpanel" aria-labelledby="flight-tab">
								<form class="form-wrap" action="" method="post">
									...
									<input type="submit" value="Register" name="register" class="primary-btn text-uppercase">								
								</form>
							  </div>
