						...
						<div class="col-lg-4 col-md-6 banner-right">
							...
							<div class="tab-content" id="myTabContent">
							  <div class="tab-pane fade show active" id="flight" role="tabpanel" aria-labelledby="flight-tab">
								<form class="form-wrap" action="flight_list.php" method="post">
									<select class="form-control" data-live-search="true" name="origin" id="origin" required onChange="loadcity(this.value)">
											<option value="" selected="selected">From </option>
											<?php
												$query=mysqli_query($con,"select * from cities WHERE state_id=4");
									...
									<input type="text" class="form-control date-picker" name="start" placeholder="Start" required>
									<input type="number" min="1" max="20" class="form-control" name="adult" placeholder="Adult" >							

									<input type="number" min="1" max="20" class="form-control" name="child" placeholder="Child">							
									<input type="submit" value="Search Flight" class="primary-btn text-uppercase">								
								</form>
							  </div>
